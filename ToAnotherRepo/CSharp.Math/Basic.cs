...
namespace Metimur.Math {
    public static class Basic {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Func<T2, T1, T3> Swap<T1, T2, T3>(this Func<T1, T2, T3> function) =>
            (x, y) => function(y, x);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Func<T2, Func<T1, T3>> Swap<T1, T2, T3>(this Func<T1, Func<T2, T3>> function) =>
            x => y => function(y)(x);
        ...
        public static Func<T1, T4> ComposeWith<T1, T2, T3, T4>(this Func<T1, T2> function1, Func<T2, T3> function2, Func<T3, T4> function3) =>
            //function1
            //.ComposeWith(function2)
            //.ComposeWith(function3)
